...
//        _fragment = LetoFragment.create(getContext(), appId, true);
        ...
        FrameLayout gameFrameLayout = view.findViewById(R.id.leto_container);
        ...
        if(gameFrameLayout.getParent() != null){
            gameFrameLayout.removeAllViews();
        }

        gameFrameLayout.addView(surfaceView, flp);

//        getChildFragmentManager()
//                .beginTransaction()
//                .add(R.id.leto_container, gameFrameLayout)
//                .commit();
